...
INSERT INTO category (name, description, image_url, is_active) VALUES ('TV', 'This is description for TV category', 'CAT_2.png', true);
...
INSERT INTO user_detail (first_name, last_name, role, enabled, password, email, contact_number)
  VALUES ('Virat', 'Kohli', 'ADMIN', true, 'admin', 'vk@gmail.com', '88888888');

INSERT INTO user_detail (first_name, last_name, role, enabled, password, email, contact_number)
  VALUES ('Ravindra', 'Jadeja', 'SUPPLIER', true, '12345', 'rj@gmail.com', '99999999');

INSERT INTO user_detail (first_name, last_name, role, enabled, password, email, contact_number)
  VALUES ('Ravicha', 'Ashwin', 'SUPPLIER', true, '12345', 'ra@gmail.com', '77777777');
...
INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id)
VALUES ('PRDDEF123DEFX', 'Sumsung s7', 'samsung', 'A smart phone by samsung!', 32000, 2, true, 3, 3);
